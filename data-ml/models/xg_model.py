...
print(mean_absolute_error(y_true=np.exp(y_test), y_pred=np.exp(xg_pred)))
print(math.sqrt(mean_squared_error(y_true=np.exp(y_test), y_pred=np.exp(xg_pred))))
print(r2_score(y_true=np.exp(y_test), y_pred=np.exp(xg_pred)))
